  ...
  panel(
    ...
    fluidRow(
      column(
        ...
        tags$p("Click on the plot to start drawing. Move the mouse to draw, and click again to stop."),
        ...
        fluidRow(
          column(12,
                 actionBttn("reset", "Reset", style = "material-flat", color = "danger", icon = icon("redo")),
                 actionBttn("predict", "Predict", style = "material-flat", color = "success", icon = icon("search"))
          )
        )
      ),
